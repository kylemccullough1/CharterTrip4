...
public class TripMigrationsTests
{
    ...
    [Fact]
    public void V19_gives_everybody_a_join_token()
    {
    ...
    [Fact]
    public void V20_renames_the_game_everywhere_a_guest_would_read_it()
    {
        var trip = LoadV18WestEgg();
    ...
    [Fact]
    public void V20_leaves_a_title_somebody_has_since_chosen_deliberately()
    {
        var trip = LoadV18WestEgg();
    ...
    [Fact]
    public void V19_and_V20_running_twice_change_nothing_the_second_time()
    {
        var trip = LoadV18WestEgg();
        TripMigrations.Apply(trip);
